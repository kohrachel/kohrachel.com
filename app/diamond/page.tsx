...
const contents: SectionProps[] = [
  {
    ...
    children: `At first glance, it looks ordinary. You probably wouldn't have noticed if you passed it on the street.
  ...
  },
  {
    ...
    children: `Life isn't always kind to the ordinary.
  ...
  },
  {
    ...
    children: `But there's only so much pressure a rock can withstand. The rock withstood and withstood, but the pressure never abated. Life can be harsh in the things that it demands of us, and it hasn't been the kindest to this rock.
  ...
  },
  {
    ...
    children: `Emerging from the fissures of the rock was a shiny diamond!
  ...
  },
  {
    ...
    children: `This rock may have looked ordinary, but it never was. Only a truly special rock could have the strength to preservere through the pressure and emerge out the other end as a diamond.
