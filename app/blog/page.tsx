  ...
  return (
    <div className="h-screen w-screen flex">
      <div className="m-4 w-full h-stretch flex rounded-xl bg-purple-100 outline outline-purple-200 shadow-xl shadow-black/30">
        <div className="w-1/6 h-full flex justify-between px-8 py-16">
        ...
        <div className="w-5/6 h-full p-2">
          <div className="flex flex-col justify-between w-stretch h-full px-16 py-12 rounded-lg gap-11 outline outline-purple-200 bg-white overflow-y-scroll">
